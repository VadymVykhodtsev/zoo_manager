...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference("Animal.count") do
      post animals_url, params: { animal: { age: @animal.age, sex: @animal.sex, species: @animal.species } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { age: @animal.age, sex: @animal.sex, species: @animal.species } }
